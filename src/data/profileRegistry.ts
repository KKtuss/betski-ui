...
export const PROFILE_SEEDS: ProfileSeed[] = [
  ...
  { handle: 'DeskWhale', displayName: 'DeskWhale', avatar: '/Stems/betskuu.png', followers: 18900, following: 44, markets: 47 },
  { handle: 'ClipQueen', displayName: 'ClipQueen', avatar: '/Stems/betskuu.png', followers: 9100, following: 312, markets: 28 },
  { handle: 'CryptoKiwi', displayName: 'CryptoKiwi', avatar: '/Stems/epstein transparent.png', followers: 4100, following: 156, markets: 14 },
  { handle: 'NovaTape', displayName: 'NovaTape', avatar: '/Stems/betskuu.png', followers: 7200, following: 201, markets: 22 },
  ...
  { handle: 'LootLord', displayName: 'LootLord', avatar: '/Stems/betskuu.png', followers: 11200, following: 93, markets: 26 }
]
...
PROFILE_AVATARS.You = '/Stems/betskuu.png'
